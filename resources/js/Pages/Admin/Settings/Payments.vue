                ...
                <CCard class="border">
                    ...
                    <CCardBody class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <CFormInput id="sp-mid" v-model="senangpay.merchant_id" class="code" autocomplete="off" data-1p-ignore data-lpignore="true" />
                        </div>
                        <div class="col-6">
                            <CFormLabel for="sp-pmid">Production merchant ID</CFormLabel>
                            <CFormInput id="sp-pmid" v-model="senangpay.pro_merchant_id" class="code" autocomplete="off" data-1p-ignore data-lpignore="true" />
                        </div>
                        <div class="col-6">
                            <CFormLabel for="sp-sk">Sandbox secret</CFormLabel>
                            <CFormInput id="sp-sk" v-model="senangpay.secret_key" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
                            <div class="form-text">{{ hint(props.senangpay.secret_key) }}</div>
                        </div>
                        <div class="col-6">
                            <CFormLabel for="sp-psk">Production secret</CFormLabel>
                            <CFormInput id="sp-psk" v-model="senangpay.pro_secret_key" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
                    ...
                    <CCardBody class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <CFormInput id="bp-collection" v-model="billplz.bill_collection_id" class="code"
                                :invalid="Boolean(billplz.errors.bill_collection_id)" autocomplete="off" data-1p-ignore data-lpignore="true" />
                        ...
                        <div class="col-6">
                            ...
                            <CFormInput id="bp-key" v-model="billplz.api_key" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
                            <div class="form-text">{{ hint(props.billplz.api_key) }}</div>
                        </div>
                        <div class="col-6">
                            <CFormLabel for="bp-sig">X-Signature key</CFormLabel>
                            <CFormInput id="bp-sig" v-model="billplz.x_signature" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
                        ...
                        <div class="col-6">
                            ...
                            <CFormInput id="bp-charge" v-model.number="billplz.bill_charge" type="number" step="0.10" min="0"
                                :invalid="Boolean(billplz.errors.bill_charge)" autocomplete="off" data-1p-ignore data-lpignore="true" />
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            ...
                            <CFormInput id="bp-slug" v-model="billplz.payment_collection_slug" class="code" autocomplete="off" data-1p-ignore data-lpignore="true" />
                ...
                <CCard class="border mb-3">
                    ...
                    <CCardBody class="row g-3">
                        <div class="col-12">
                            ...
                            <CFormInput id="st-pk" v-model="stripe.publish_key" class="code" :invalid="Boolean(stripe.errors.publish_key)" autocomplete="off" data-1p-ignore data-lpignore="true" />
                        </div>
                        <div class="col-6">
                            <CFormLabel for="st-sk">Secret key</CFormLabel>
                            <CFormInput id="st-sk" v-model="stripe.secret_key" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
                            <div class="form-text">{{ hint(props.stripe.secret_key) }}</div>
                        </div>
                        <div class="col-6">
                            <CFormLabel for="st-wh">Webhook secret</CFormLabel>
                            <CFormInput id="st-wh" v-model="stripe.webhook_secret" type="password" autocomplete="new-password" data-1p-ignore data-lpignore="true" />
