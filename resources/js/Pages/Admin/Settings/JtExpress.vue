            ...
            <CCardBody>
                <form class="row g-3" @submit.prevent="form.put('/admin/jt-express', { preserveScroll: true })">
                    ...
                    <div class="col-md-6">
                        ...
                        <CFormInput id="jt-url" v-model="form[live ? 'url_production' : 'url_sandbox']" class="code" />
                    </div>
                    <div class="col-md-6">
                        <CFormLabel for="jt-user">Username</CFormLabel>
                        <!-- `username_sanbox` is the source's own spelling. -->
                        <CFormInput id="jt-user" v-model="form[live ? 'username_production' : 'username_sanbox']" />
                    </div>
                    <div class="col-md-6">
                        <CFormLabel for="jt-cus">Customer code</CFormLabel>
                        <CFormInput id="jt-cus" v-model="form[live ? 'cuscode_production' : 'cuscode_sandbox']" class="code" />
                    </div>
                    <div class="col-md-6">
                        <CFormLabel for="jt-pw">Password</CFormLabel>
                        <CFormInput id="jt-pw" v-model="form[live ? 'password_production' : 'password_sandbox']" type="password" autocomplete="off" />
                    ...
                    <div class="col-md-6">
                        ...
                        <CFormInput id="jt-key" v-model="form[live ? 'key_production' : 'key_sandbox']" type="password" autocomplete="off" />
